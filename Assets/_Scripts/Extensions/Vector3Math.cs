...
public static class Vector3Math
{
	...
	public static Vector3 SetX(this in Vector3 vector, in int x)
	{
		var v = vector;
		v.x = x;
		return v;
	...
	public static Vector3 SetY(this in Vector3 vector, in int y)
	{
		var v = vector;
		v.y = y;
		return v;
	...
	public static Vector3 SetZ(this in Vector3 vector, in int z)
	{
		var v = vector;
		v.z = z;
		return v;
