...
namespace Utils.RagdollEditor
{

	[CustomEditor(typeof(RagdollEditor))]
	public class RagdollEditorInspector : UnityEditor.Editor {
		...
		void OnSceneGUI() {
			...
			// Selected
			Transform selected = script.mode == Utils.RagdollEditor.RagdollEditor.Mode.Colliders? (script.selectedCollider != null? script.selectedCollider.transform: null): (script.selectedRigidbody != null? script.selectedRigidbody.transform: null);
