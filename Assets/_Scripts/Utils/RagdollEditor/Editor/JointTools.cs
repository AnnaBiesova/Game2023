...
namespace Utils.RagdollEditor
{
	...
	public class JointTools: UnityEditor.Editor {
		...
		public static void SwitchXY(ref ConfigurableJoint joint) {
			...
			(joint.axis, joint.secondaryAxis) = (joint.secondaryAxis, joint.axis);
		}
		...
		public static void SwitchXY(ref CharacterJoint joint) {
			...
			(joint.axis, joint.swingAxis) = (joint.swingAxis, joint.axis);
		}
